...
// Assume you have these categories. Adjust as needed.
const categories = [
    "Clothes",
    "Accessories",
    "Electronics",
            ...
            <div className="container mx-auto px-4">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div className="flex justify-center items-center">
                        <img src="/imgs/ShopLoop_logo.png" alt="ShopLoop Logo" className="h-16" />
                    </div>
                        ...
                        <ul>
                            {categories.map((category, index) => (
                                <li key={index} className="mb-2">
                                    <button
                                        onClick={() => handleCategoryClick(category)} className="hover:text-red-500 transition duration-300">
                                        {category}
                                    </button>
                                </li>
                            ))}
